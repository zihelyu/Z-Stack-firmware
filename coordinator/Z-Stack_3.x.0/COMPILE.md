...
1. Copy `firmware.patch` to the SDK installation folder, open a Git Bash in this folder and apply the patch using `git apply --exclude='cc13xx-cc26xx_sdk' --ignore-space-change firmware.patch`.
